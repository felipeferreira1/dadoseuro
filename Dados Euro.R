...
export(pib_AE, "dados_euro.xlsx", sheetName = "pib_AE")
...
export(pib_paises, "dados_euro.xlsx", which = "pib_paises")
...
export(tabela1, "dados_euro.xlsx", which = "tabela1")
...
export(tabela2, "dados_euro.xlsx", which = "tabela2")
...
export(tabela3, "dados_euro.xlsx", which = "tabela3")
...
export(tabela4, "dados_euro.xlsx", which = "tabela4")
...
export(inflacao_merge, "dados_euro.xlsx", which = "inflacao")
...
export(producao_industrial_mensal_merge, "dados_euro.xlsx", which = "producao industrial mensal")
...
export(producao_industrial_trimestral_merge, "dados_euro.xlsx", which = "producao industrial trimestral")
...
export(vendas_varejo_filtrado, "dados_euro.xlsx", which = "vendas_varejo")